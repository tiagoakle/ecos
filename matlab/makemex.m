...
if( any(strcmpi(what,'ecos')) || any(strcmpi(what,'all')) ) 
    ...
    files = {'ecos', 'kkt', 'cone', 'spla', 'ctrlc', 'timer', 'preproc', 'splamm', 'equil', 'wright_omega'};
    for i = 1 : length (files)
